...
WORDLIST_FILENAME = "/Users/hanaum/Documents/6.00.1xFiles/ProblemSet4/words.txt"
...
def getWordScore(word, n):
    ...
    if len(word) == n:
        score += (letter_points * len(word)) + 50
    else:
        score += letter_points * len(word)
    return score
#
    ...
    * The hand finishes when there are no more unused letters or the user
    ...
    while n > 0:
        ...
        if not isValidWord(word, hand, wordList):
            ...
            t_score += getWordScore(word, n)
            print word + " earned " + str(getWordScore(word , n)) + " points. " + "Total: " + str(t_score) + " points\n"
            hand = updateHand(hand, word)
            if calculateHandlen(hand) == 0:
                break

    if calculateHandlen(hand) == 0:
        print "Run out of letters. Total score: " + str(t_score) + " points."
    else:
        print "Goodbye! Total Score: " + str(t_score) + " points."
    '''
    ...
    while n > 0:
        ...
        if word == ".":
            ...
            if isValidWord(word, current_hand, wordList) == False:
                print "Invalid word, please try again."
                print
            elif isValidWord(word, current_hand, wordList) == True:
