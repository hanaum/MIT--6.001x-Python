...
class NewsStory(object):
    def __init__(self, guid, title, subject, summary, link):
        self.cguid = guid
        self.ctitle = title
        self.csubject = subject
        self.csummary = summary
        self.clink = link
...
def filterStories(stories, triggerlist):
    ...
    for story in stories:
        for trigger in triggerlist:
            if trigger.evaluate(story) and story not in hitStories:
                hitStories.append(story)
...
def makeTrigger(triggerMap, triggerType, params, name):
    ...
    if triggerType == 'TITLE':
        ...
        triggerMap[name] = NotTrigger(triggerMap[params])

    elif triggerType == 'AND':
        triggerMap[name] = AndTrigger(triggerMap[original_params[0]], triggerMap[original_params[1]])

    elif triggerType == 'OR':
        triggerMap[name] = OrTrigger(triggerMap[original_params[0]], triggerMap[original_params[1]])
